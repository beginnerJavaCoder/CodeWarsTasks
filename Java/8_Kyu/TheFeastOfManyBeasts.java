/*
Original task - https://www.codewars.com/kata/the-feast-of-many-beasts
...
public class Kata {
    public static boolean feast(String beast, String dish) {
        return beast.codePointAt(0) == dish.codePointAt(0) &&
               beast.codePointAt(beast.length()-1) == dish.codePointAt(dish.length()-1);
    }
}