/*
Original task - https://www.codewars.com/kata/age-range-compatibility-equation
...
public class Kata {
    public static String datingRange(int age) {
        if(age < 15) return String.format("%d-%d", (int) (0.9 * age), (int) (1.1 * age));
        return String.format("%d-%d", (int) age / 2 + 7, (int) (age-7)*2);
    }
}