/*
Original task - https://www.codewars.com/kata/special-number-special-numbers-series-number-5

Definition
A number is a Special Number if it’s digits only consist 0, 1, 2, 3, 4 or 5.

Task
Given a number determine if it special number or.
...
public class Solution {
    public static String specialNumber(int number) {
        return (number + "").replaceAll("[6-9]", "").equals(number + "") ? "Special!!" : "NOT!!";
    }
}