/*
Original task - https://www.codewars.com/kata/a-rule-of-divisibility-by-13
...
class Thirteen {
    private static final int[] row = {1, 10, 9, 12, 3, 4};
    ...
    public static long thirt(long n) {
        ...
        for(int i = strNum.length()-1; i >= 0; i--) {
            ...
            sum += Integer.parseInt(strNum.charAt(i) + "") * row[index];
            index++;
        }
        if(sum == n) return sum;
        return thirt(sum);
