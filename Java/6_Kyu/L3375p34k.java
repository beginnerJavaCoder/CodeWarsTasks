/*
Original task - https://www.codewars.com/kata/l3375p34k

General Objective
The objective of this Kata is to provide some way to encode a string into its leetspeak version.

Specific Instructions
1) The code must contain a Leetspeak class inherited from an 
Encoder abstract class and containing an encode(String) method returning itself the encoded String.
