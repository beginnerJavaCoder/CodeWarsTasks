/*
Original task - https://www.codewars.com/kata/5a045fee46d843effa000070
...
class FactDecomp {
    public static String decomp(int n) {
        ...
        BigInteger primeFactor = new BigInteger("2");
        int currentPrime = primeFactor.intValue();
        ...
        while (currentPrime <= n) {
            ...
            int factorOfPower;
            do {
                factorOfPower =  n / (int) Math.pow(currentPrime, index);
                power += factorOfPower;
                index++;
            } while(factorOfPower > 0);
            ...
            primeFactor = primeFactor.nextProbablePrime();
            currentPrime = primeFactor.intValue();
        }
